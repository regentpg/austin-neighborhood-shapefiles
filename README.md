These polygons of Austin neighbodhoods are derived from Zillow's neighborhood shapefiles, along with the addition of selected west Austin neighborhoods from Austin GIS data.
